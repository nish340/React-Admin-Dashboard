...
const features = [
    {
        ...
        desc: 'DemoProject comes with a variety of ready-to-use applications and pages that help to speed up the development',
        image: image1,
        features: [
            'Projects & Tasks',
    ...
    },
    {
        ...
        desc: 'The simplest and fastest way to build dashboard or admin panel. DemoProject is built using the latest tech and tools and provide an easy way to customize anything, including an overall color schemes, layout, etc.',
        image: image2,
        features: [
...
const rawFaqs = [
    ...
    {
        id: 4,
        question: 'Will you regularly give updates of DemoProject?',
        answer: 'Yes, We will update the DemoProject regularly. All the future updates would be available without any cost.',
        titleClass: 'text-body',
        textClass: 'pb-1 text-muted',
    },
];
