...
const Projects = (): React$Element<React$FragmentType> => {
    const projects = [
        ...
        {
            id: 3,
            title: 'DemoProject v2.1 - Angular and Django',
            state: 'Ongoing',
        ...
        {
            id: 4,
            title: 'DemoProject v2.1 - React, Webpack',
            state: 'Finished',
        ...
        {
            id: 5,
            title: 'DemoProject 2.2 - Vue.Js and Laravel',
            state: 'Ongoing',
            image: projectImg1,
            totalTasks: 3,
            totalComments: 104,
        ...
        {
            id: 6,
            title: 'DemoProject 2.3 - Rails, NodeJs, Mean',
            state: 'Planned',
            image: projectImg2,
            totalTasks: 11,
            totalComments: 201,
        ...
        {
            id: 7,
            title: 'DemoProject - Landing page and UI Kit',
            state: 'Planned',
            image: projectImg3,
            totalTasks: 3,
            totalComments: 104,
